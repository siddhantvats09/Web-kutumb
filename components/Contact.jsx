      ...
      <div className="max-w-4xl mx-auto bg-[#1f1f2e] rounded-2xl shadow-2xl p-10 md:p-14">
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <select className="w-full bg-[#2b2b3a] text-white border border-gray-600 rounded-xl px-4 py-3 pr-12 focus:outline-none focus:ring-2 focus:ring-purple-400 transition">
